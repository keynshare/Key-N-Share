...
function PrimaryBtn({children,onClick,sparkelClass,className,classInner,classsecondInner,disabled,Hovered=false,Href,Type}:PropTypes) {
  return (
   <>
   {Href ?
...
<button type={Type ? Type : 'button' } disabled={disabled} onClick={onClick} className={clsx( className ,"relative group w-fit h-fit")}> 
