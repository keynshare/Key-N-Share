...
export default function Tutorial() { 
  ...
  return (
   <div className='p-4  bg-[#F2F2F2] dark:bg-[#0f0f0f] relative mb-24 mt-28 sm:mb-64 sm:mt-40 px-5 sm:px-11 lg:px-20 xl:px-10 max-h-[400px] md:max-h-[540px] lg:max-h-[630px] mx-[5vw] xl:max-h-[650px] 2xl:max-h-[700px] xl:mx-[15vw] 2xl:mx-[18vw] 3xl:mx-[25vw] gap-10 rounded-xl md:rounded-3xl flex flex-col items-center justify-center '>

            <div className='h-1 sm:h-4 md:h-40 lg:h-52 2xl:h-64'>
        <div className='rounded-full flex items-center justify-center -translate-y-[35%] sm:-translate-y-[19%] md:translate-y-[40%] lg:translate-y-[50%] w-40 h-40 md:w-48 md:h-48 border-8 border-white dark:border-black bg-[#F2F2F2] dark:bg-[#0f0f0f] '>
