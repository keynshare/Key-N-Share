...
function HeroSection() {
  ...
  return (
   ...
   <div className='flex flex-col z-50 relative items-center gap-9  justify-center h-screen md:h-[580px] xl:h-[700px] w-screen px-[5vw] '>
      ...
      <div className={`flex justify-center items-center  gap-3 [background:#192B42/25] backdrop-blur-xl shadow-[0_0_2px_0_#12e3ffde_inset] px-[15px] py-[5px] rounded-full border-[0.75px] border-[rgba(25,43,66,0.25)] transform transition-all duration-1000 ease-out ${
