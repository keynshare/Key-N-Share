...
export default function Features() {
  ...
  const cardConfigurations = [
    {
      ...
      color: { gap: 6, speed: 25,colors: ["#4287f5", "#5c9bff", "#89c2ff"]}
    },
    {
      ...
      label: "Secure Upload",
      color: "#e0f2fe",
      canvasProps: { gap: 6, speed: 25,  colors: "#f3e8ff, #c084fc, #9333ea" }
    },
    {
      ...
      color: "#fef08a",
      canvasProps: { gap: 6, speed: 20, colors: "#8DFF58, #2BFF00, #006813" }
    },
    {
  ...
  return (
    ...
    <h2 className="text-xl md:text-3xl lg:text-[42px] text-center font-bold font-bricola text-gray-900 mb-4">
    Your Data. Your Rules. Our Technology.
    </h2>   
    <main className="m-auto grid min-h-[320px] w-full max-w-5xl grid-cols-1 gap-8 bg-background p-4 text-gray-800 dark:bg-background dark:text-[#e3e3e3] sm:grid-cols-2 lg:grid-cols-4">
