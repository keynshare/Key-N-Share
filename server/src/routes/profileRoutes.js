...
router.get('/me/datasets', authenticateToken, getUserDatasets); // Get current user's datasets
router.get('/me/sold-datasets', authenticateToken, getUserSoldDatasets); // Get current user's sold datasets
router.get('/me/statistics', authenticateToken, getUserStatistics); // Get current user's statistics
